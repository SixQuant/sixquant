...
class TestMethods(unittest.TestCase):
    def test_translate_field_name(self):
        ...
        self.assertEqual((['close', 'pt_price'], True), translate_field_name(['close', 'pt_close'], reverse=reverse))

        self.assertEqual(('pt_close', True), translate_field_name('pt_price', reverse=False))
        self.assertEqual(('amount', True), translate_field_name('money', reverse=False))
